...
- [FDE and Agent Lifecycle Governance](./research/working-papers/fde-agent-lifecycle-governance.md) · [中文版](./research/working-papers/fde-agent-lifecycle-governance.zh-CN.md) explains how Full Spectrum can strengthen FDE handover and long-term Agent governance. It is a non-normative working paper, not a prediction that FDE projects inevitably fail.
